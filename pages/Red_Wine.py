...
citric_acid = st.number_input('Citric acid:', min_value=0.00, max_value=1.0, value=1.0)
...
if st.button('Predecir la calidad del vino blanco'):
    ...
    if wine == 1:
        st.header('Good Quality Red Wine')
        st.image("images\red-wine-predict.jpg")
    else:
        st.header('Bad Quality Red Wine')
        st.image("images\Bad_quality_red_wine.jpg")